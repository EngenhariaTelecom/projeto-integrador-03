...
int autoState = 0;  // 0=carga, 1=descarga
    ...
    if (mode == AUTO) {
      ...
      if (autoState == 0) {
          ...
          if (v_batt < V_BATT_MAX) {
              ...
              // atingiu o máximo - troca para descarga
              autoState = 1;
          ...
          if (v_batt > V_BATT_MIN) {
              ...
              // atingiu o mínimo - troca para carga
              autoState = 0;
